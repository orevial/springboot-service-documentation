...
/**
 * Springboot Service Documentation main settings class
 */
@ConfigurationProperties(prefix = "springboot-service-documentation")
public class ServiceDocumentationSettings {
